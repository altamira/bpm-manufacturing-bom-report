...
public class ServiceOrderEditorReport extends ReportConfig {
...
public OrderDataBean getData(String id) {
	...
	public Response getReport(String id) {
        ...
        parameters.put("Title", "￼￼￼Ordem de Serviço (Montagem)");
     	...
     	//GET THE JASPER FILE
		InputStream reportStream = getClass().getResourceAsStream("/reports/service-order-editor/service-order-editor-report.jasper");
