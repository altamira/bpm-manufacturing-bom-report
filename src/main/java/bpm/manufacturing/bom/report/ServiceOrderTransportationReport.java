...
public class ServiceOrderTransportationReport extends ReportConfig {
...
public OrderDataBean getData(String id) {
	...
	public Response getReport(String id) {
        ...
        parameters.put("Title", "￼￼Ordem de Serviço (Transporte)");
     	...
     	//GET THE JASPER FILE
		InputStream reportStream = getClass().getResourceAsStream("/reports/service-order-transportation/service-order-transportation-report.jasper");
