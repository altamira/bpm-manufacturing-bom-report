...
public class ServiceOrderShippingReport extends ReportConfig {
...
public OrderDataBean getData(String id) {
	...
	public JasperPrint getPDF(String id) {
        ...
        parameters.put("Title", "Ordem de Serviço (Expedição)");
     	...
     	//GET THE JASPER FILE
		InputStream reportStream = getClass().getResourceAsStream("/reports/service-order-shipping/service-order-shipping-report.jasper");
